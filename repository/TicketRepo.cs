        ...
        public IEnumerable<Ticket> getAll()
        {
            ...
            using (SqlDataReader reader = sql.ExecuteReader())
            {
                while (reader.Read())
                {
                    ...
                    Ticket ticket = new Ticket(i, new Festival(fid, DateTime.Now, "", "", "", 0, null), price, cid, seats);
                    tickets.Add(ticket);
                }
                connection.Close();
            }
        ...
        public Ticket getOne(long id)
        {
            ...
            using (SqlDataReader reader = sql.ExecuteReader())
            {
                while (reader.Read())
                {
                   ...
                   ticket = new Ticket(i, new Festival(fid,DateTime.Now,"","","",0,null), price, cid, seats);
                }
                connection.Close();
            }
