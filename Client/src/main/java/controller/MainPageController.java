...
public class MainPageController implements IObserver, Serializable {
    ...
    private void initModelSFestivals(Date date){
        ...
        Iterable<FestivalDTO> finalFestivals = festivals;
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                List<FestivalDTO> festivalList= StreamSupport.stream(finalFestivals.spliterator(),false).collect(Collectors.toList());
